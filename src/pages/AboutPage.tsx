...
import { ArrowRight, Target, Eye, Rocket, Shield, Award, Users, HelpCircle } from "lucide-react";
            ...
            <div className="container mx-auto px-4 md:px-6">
              ...
              >
                ...
                <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                  Our products and processes are certified to meet the highest standards 
                  of quality, safety, and regulatory compliance.
                </p>
                <div className="flex flex-wrap justify-center gap-4">
                  {["ISO 9001:2015", "Quality Certified", "DGCA Approved", "Make in India"].map((cert) => (
                    <div key={cert} className="px-6 py-3 bg-primary/10 rounded-lg border border-primary/20">
